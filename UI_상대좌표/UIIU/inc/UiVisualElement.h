...
#ifndef _UI_VISUAL_ELEMENT_H_
#define _UI_VISUAL_ELEMENT_H_
...
/**
 * [UiVisualElement] UiApp must inherit from UiApp class
...
public:
	/**
	 * [UiVisualElement] UiApp must have a factory method that creates an instance of itself.
	 */
	static Tizen::App::UiApp* CreateInstance(void);

public:
	UiVisualElement(void);
	virtual ~UiVisualElement(void);
