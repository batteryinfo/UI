...
Process Name: UIIU
PID: 6733
Date: 2014-12-07 16:56:01(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 6733, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001a4d
r2   = 0x00000006, r3   = 0x00001a4d
r4   = 0x00000006, r5   = 0x404bfbe4
r6   = 0x404bf000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xbee2bae4
r10  = 0x40089000, fp   = 0xbee2b9b0
ip   = 0x400894c0, sp   = 0xbee2a448
lr   = 0x403c655c, pc   = 0x403c2760
cpsr = 0x20000010
...
Callstack Information (PID:6733)
Call Stack Count: 43
 0: gsignal + 0x3c (0x403c2760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0x403c655c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0x403bb63c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x9e (0x42e1e0b7) [/usr/lib/osp/libosp-appfw.so] + 0x1400b7
 4: Tizen::Graphics::Font::Construct(int, int) + 0xda (0x437eb9af) [/usr/lib/osp/libosp-uifw.so] + 0x5fa9af
 5: MainForm::OnInitializing() + 0x958 (0x448cc754) [/opt/apps/JxWZypK112/bin/UIIU.exe] + 0xa754
 6: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0x434a8833) [/usr/lib/osp/libosp-uifw.so] + 0x2b7833
 7: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x28 (0x4366a435) [/usr/lib/osp/libosp-uifw.so] + 0x479435
 8: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0x43490e97) [/usr/lib/osp/libosp-uifw.so] + 0x29fe97
 9: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xf2 (0x4349403b) [/usr/lib/osp/libosp-uifw.so] + 0x2a303b
10: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x5a (0x43496a43) [/usr/lib/osp/libosp-uifw.so] + 0x2a5a43
11: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xa4 (0x434b3de5) [/usr/lib/osp/libosp-uifw.so] + 0x2c2de5
12: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0x4348b217) [/usr/lib/osp/libosp-uifw.so] + 0x29a217
13: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0x4348b2a3) [/usr/lib/osp/libosp-uifw.so] + 0x29a2a3
End of Call Stack
